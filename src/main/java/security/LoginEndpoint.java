...
public class LoginEndpoint {
    ...
    public Response login(String jsonString) throws AuthenticationException, API_Exception {
        ...
        try {
            Account account = ACCOUNT_FACADE.getVeryfiedAccount(username, password);
            String token = createToken(username, account.getRolesAsStrings());
            JsonObject responseJson = new JsonObject();
            responseJson.addProperty("username", username);
            /*JsonArray roles = new JsonArray();
            for (String role: account.getRolesAsStrings()) {
                roles.add(role);
            }
